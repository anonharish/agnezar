...
export const useAboutUs = () => {
  ...
  const cards = [
    {
      title: "Our Mission",
      description: "At Agnezar, we deliver analytical excellence through science, precision, and technology. Our mission is to provide accurate and compliant analytical solutions that advance products from concept to commercialization. By embracing AI-driven analytics and a culture of innovation and collaboration, we enhance data integrity, ensure regulatory confidence, and drive continuous improvement",
      icon: "assets/icons/mission-icon.png",
    },
    {
      title: "Our Vision",
      description:
        "To be a global leader in next-generation analytical science, empowering the pharmaceutical and healthcare industries through innovation, precision, and integrity.We envision Agnezar as a catalyst for scientific excellence—where advanced technology, intelligent analytics, and collaborative expertise redefine quality standards and accelerate the development of safe, effective, and accessible healthcare solutions worldwide.",
